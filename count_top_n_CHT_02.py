...
parser.add_argument('-r', '--recipient_domain', nargs='*', action="append",dest='recipient_domain',help='Email recipient domain')
...
if "score" in a[0].keys():
    for i in range(len(a)):
        if len(recipient_domain) >= 1:
            for dns in recipient_domain:
                if dns in a[i]["recipient"]:
                    if a[i]["score"] >= 70: 
...
#if "score" in a[0].keys():
#    for i in range(len(a)):
#        if "eztour" in a[i]["recipient"]:
#            if a[i]["score"] >= 70:
#                c.append(a[i][keyvalue])
#if "score" in a[0].keys():
#    for i in range(len(a)):
#        if "cargo.com.tw" in a[i]["recipient"]:
#            if a[i]["score"] >= 70:
#                c.append(a[i][keyvalue])
#if "score" in a[0].keys():
#    for i in range(len(a)):
#        if "signet.com.tw" in a[i]["recipient"]:
#            if a[i]["score"] >= 70:
#                c.append(a[i][keyvalue])
#if "score" in a[0].keys():
#    for i in range(len(a)):
#        if "everfuntravel.com" in a[i]["recipient"]:
#            if a[i]["score"] >= 70:
#                c.append(a[i][keyvalue])
